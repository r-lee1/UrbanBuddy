...
var _api_util = __webpack_require__(126);
...
window.onload = function () {
  ...
  var getCityScores = function getCityScores(city) {
    return (0, _api_util.getCity)(city).then(function (obj) {
      cityData[city] = {};
  ...
  var updateDataset = function updateDataset(chart, city, title) {
    var newData = cityData[city]["scores"].map(function (score) {
      return score.score_out_of_10;
    });
    chart.data.datasets[0].data = newData;

    var newColors = cityData[city]["scores"].map(function (score) {
      return score.color;
    });
    chart.data.datasets[0].backgroundColor = newColors;

    var newLabels = cityData[city]["scores"].map(function (score) {
      return score.name;
    });
  ...
  var updateSummary1 = function updateSummary1(city) {
    $("#summary1").html(cityData[city]["summary"]);
  };

  var updateSummary2 = function updateSummary2(city) {
    $("#summary2").html(cityData[city]["summary"]);
  };

  var updateComparisonDataset1 = function updateComparisonDataset1(city) {
    var newData = cityData[city]["scores"].map(function (score) {
      return score.score_out_of_10;
    });
  ...
  var updateComparisonDataset2 = function updateComparisonDataset2(city) {
    var newData = cityData[city]["scores"].map(function (score) {
      return score.score_out_of_10;
    });
  ...
  var randomCitySelector = function randomCitySelector(chartSelection) {
    var maxIndex = chartSelection.options.length;
    var index = getRandomInt(maxIndex);
    chartSelection.options[index].selected = true;
    var option = chartSelection.options[index];
    chartSelection.onchange({ "target": option });
  };

  var chart1Selection = document.getElementById('chart1Selection');

  chart1Selection.onchange = function (e) {
    var city = e.target.value;
    var titleWords = e.target.value.split("-");
    var title = void 0;

    if (city === "washington-dc") {
      title = "Washington, D.C";
    } else {
      title = titleWords.map(function (word) {
    ...
    if (cityData[city]) {
      ...
      getCityScores(city).then(function () {
        updateDataset(chart1, city, title);
        updateComparisonDataset1(city);
        updateSummary1(city);
      });
  ...
  var chart2Selection = document.getElementById('chart2Selection');
  ...
  var chart1 = new _chart2.default(ctx1, {
    type: 'horizontalBar',
    data: {
      labels: [],
      datasets: [{
  ...
  var chart2 = new _chart2.default(ctx2, {
    type: 'horizontalBar',
    data: {
      labels: [],
      datasets: [{
  ...
  var comparisonChart = new _chart2.default(ctx3, {
    type: 'horizontalBar',
    data: {
...
var getCity = exports.getCity = function getCity(city) {
  return $.ajax({
